      ...
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        >
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            ...
            <g-link v-else to="/#team" class="text-copy-primary hover:text-gray-600">Team</g-link>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
...
<!-- TODO youtube? -->
          <!-- <li class="mr-8">
            <a href="https://youtube.com/aproflow" target="_blank" class="text-white hover:text-gray-400">
          ...
          <!-- <li class="mr-8">
            <a href="https://github.com/aproflow" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://twitter.com/aproflow" target="_blank" class="text-white hover:text-gray-400">
